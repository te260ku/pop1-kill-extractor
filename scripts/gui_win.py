...
def draw():
    ...
    ************************************************************'''
    ...
    progress_bar_comp = sg.ProgressBar(100, orientation='h', size=(34,25), key='progressBar')
    ...
    kill_time_log_comp = sg.Multiline(size=(28,10), key='killTimeLog', disabled=True, expand_x=True)
    ...
    layout_1 = [  
        [file_select_button_comp, sg.Input(font=(gui_font, 14))], 
    ...
    layout=[
        ...
        # ],
        [sg.Frame('Setting', layout_1)], 
        [
            sg.Frame('Preview', layout_2, expand_y=True, expand_x=True), 
            sg.Frame('Log', layout_3, expand_x=True), 
        ], 
    ]
